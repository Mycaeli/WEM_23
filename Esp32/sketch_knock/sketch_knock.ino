...
const int ledPin = 33;       // LED connected to digital pin 13
...
/**/
const int ledPin2 = 32;       // LED connected to digital pin 13
const int knockSensor2 = 14;  // the piezo is connected to analog pin 0
